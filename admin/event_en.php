...
<body>
    ...
    <div class="page-content">
    	<div class="row">
		  	...
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <li><a href="new_en.php"><i class="fa fa-plus-square" aria-hidden="true"></i> News EN</a></li>
 					...
 					<li class="current"><a href="event_en.php"><i class="fa fa-plus-square" aria-hidden="true"></i> Event EN</a></li>
		  ...
		  <div class="col-md-10">
			<div id="frm">
			<center><h1>Event English</h1></center>
			<form action="process_event_en.php" method="POST" enctype="multipart/form-data">
				<div class="col-md-12">
