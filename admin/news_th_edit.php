...
<body>
    ...
    <div class="page-content">
    	<div class="row">
		  ...
		  <?php
		  	$id_news_th = $_POST["id_news_th"];
		  	$text_news_th = $_POST["text_news_th"];
		  	$img_news_th = $_POST["name_file_img"];
		  ?>
		  <div class="col-md-10">
			<div id="frm">
			<center><h1>Edit News Thai</h1></center>
			<form action="process_new_th_edit.php" method="POST" enctype="multipart/form-data">
			<?php
			...
			?>
				<div class="col-md-12">
					...
					<div class="col-md-8">
						...
						<br>
						<?php
						echo '<img src="../uploads/news_th/'.$img_news_th.'" width="200px" height="200px">';
						?>
						<br>
