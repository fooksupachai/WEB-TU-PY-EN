...
<body>
    ...
    <div class="page-content">
    	<div class="row">
                ...
                <ul class="nav">
                    ...
                    <li><a href="new_en.php"><i class="fa fa-plus-square" aria-hidden="true"></i> News EN</a></li>
 					...
 					<li><a href="event_en.php"><i class="fa fa-plus-square" aria-hidden="true"></i> Event EN</a></li>
 					 <li class="current"><a href="per_th.php"><i class="fa fa-plus-square" aria-hidden="true"></i> per TH</a></li>
 					 <li class="current"><a href="per_en.php"><i class="fa fa-plus-square" aria-hidden="true"></i> per EN</a></li>
		  ...
		  <div class="col-md-10">
			<div id="frm">
			<center><h1>Per Thai</h1></center>
			<form action="process_per_th.php" method="POST" enctype="multipart/form-data">
				<div class="col-md-12">
