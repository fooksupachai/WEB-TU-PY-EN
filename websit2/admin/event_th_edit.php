...
<body>
    ...
    <div class="page-content">
    	<div class="row">
		  ...
		  <?php
		  	$id_event_th = $_POST["id_event_th"];
		  	$text_event_th = $_POST["text_event_th"];
		  	$date_event = $_POST["date_event"];
		  ?>
		  <div class="col-md-10">
			<div id="frm">
			<center><h1>Edit Event Thai</h1></center>
			<form action="process_event_th_edit.php" method="POST" enctype="multipart/form-data">
				<div class="col-md-12">
					<div class="col-md-2"></div>
					<div class="col-md-8">
						<label>Date</label>
						<?php
							echo "<input type='text' class='form-control' name='date-th' id='date-th' value='".$date_event."'/>";
							echo "<input type='hidden' name='id_event_th' value=".'"'.$id_event_th.'"'."/>"; 
						?>
						<label>Edit Text</label>
						<textarea class="form-control" name="event-text-th" id="event-text-th"><?php echo $text_event_th;?></textarea><br>
						<div class="col-md-12">
