		  	...
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <li><a href="manage_new_th.php"><i class="fa fa-plus-square" aria-hidden="true"></i> Manage New TH</a></li>
                     <li><a href="manage_new_en.php"><i class="fa fa-plus-square" aria-hidden="true"></i> Manage New En</a></li>
                </ul>
             </div>
		  </div>
		  <?php
		  	$id_news_en = $_POST["id_news_en"];
		  	$text_news_en = $_POST["text_news_en"];
		  	$img_news_en = $_POST["name_file_img"];
		  ?>
		  <div class="col-md-10">
			<div id="frm">
			<center><h1>Edit News ENGLISH</h1></center>
			<form action="process_new_en_edit.php" method="POST" enctype="multipart/form-data">
			<?php
				echo "<input type='hidden' name='id_news_en' value=".'"'.$id_news_en.'"'."/>"; 
			?>
				<div class="col-md-12">
					...
					<div class="col-md-8">
						...
						<br>
						<?php
						echo '<img src="../uploads/news_en/'.$img_news_en.'" width="200px" height="200px">';
						?>
						<br>
						<label>Edit News Text</label>
						<textarea class="form-control" name="new-text-en" id="new-text-en"><?php echo $text_news_en;?></textarea><br>
						<div class="col-md-12">
